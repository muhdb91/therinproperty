      ...
      case 'property-detail':
        return selectedProperty ? (
          <div className="max-w-7xl mx-auto p-8">
            <button onClick={() => setView('public')} className="mb-6 text-gray-500 hover:text-blue-600 transition-colors"><i className="fas fa-arrow-left mr-2"></i> Back to Listings</button>
